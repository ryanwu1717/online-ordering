...
<div class="row">
  <div class="col-12 mb-4">
    <div class="card shadow mb-4 h-100">
      <div class="card-header">製程確認</div>
      <div class="card-body">
          ...
          <div class="col-12 col-md">
            ...
            <div class="form-group row">
              <div class="col-sm-auto form-group row">
                <label class="col-form-label col-auto">起始時間：</label>
                <div class="col-auto">
                  <input class="form-control" type="date"/>
                </div>
              </div>
              <div class="col-sm-auto form-group row">
                <label class="col-form-label col-auto">結束時間：</label>
                <div class="col-auto">
                  <input class="form-control" type="date"/>
                </div>
              </div>
      ...
      success: function(response) {
        ...
        $.each(response.process, function(key, value) {
          ...
          $('#divImage').append(`
            ...
            <div class="col">
              <div class="collapse multi-collapse" id="divCollapse_${key+1}">
                <div class="card">
                  <div class="card-body">
                    <div class="form-group row">
                ...
                if ($(`#divImage_${response.id}  #divImageResultMatch_${responseItem.id}`).length == 0) {
                  ...
                  var $tmpAppend = `
                    <tr name="divImageResultMatch${response.id}" id="divImageResultMatch_${responseItem.id}" data-avg="${Number.parseFloat(responseItem.avg).toFixed(2)}" >
                      ...
                      <td>${comment_other}<input  onfocus="inputFocus(${response.id},${responseItem.id})" type="text" value="${comment!=null?comment:''}" class="form-control" name="inputComment" data-process_id="${response.id}" data-crop_id="${responseItem.id}" data-confidence="${Number.parseFloat(responseItem.avg).toFixed(2)}"/></td>
                ...
                if(index==0){
                    ...
                    $(response.process).each(function(){
                      ...
                      $.each(row,function(key,value){
                        if(tmpIndex > 2){
                            $(`#divImage_${response.id} #divImageResultMatch_${responseItem.id} #divImage_${response.id}_multiCollapseExample${responseItem.id} [name="collapseDetail"]`).append(`
