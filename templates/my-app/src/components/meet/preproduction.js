...
class PreproductionBlock extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [
        {
          name: '週數',
          selector: row => parseInt(row.週數),
          width: "10%",
          center:true
        },
        {
          name: '預計生產完成日',
          selector: row => row.預計生產完成日,
        },
        {
          name: '盤數',
          selector: row => row.盤數,
        ...
        {
          name: '現場完成量',
          selector: row => Math.round(row.現場完成量),
        },
        {
          name: '外注完成量',
          selector: row => Math.round(row.外注完成量),
        },
      ],
      external_injection: "",
      on_site: "",
...
export default PreproductionBlock;
